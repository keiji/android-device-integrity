...
object GooglePlayIntegrityTokenRepositoryModule {
    ...
    fun provideGooglePlayIntegrityTokenRepository(
        ...
        standardIntegrityManagerProvider: StandardIntegrityManagerProvider // Provider for standard requests
    ): GooglePlayIntegrityTokenRepository {
        return GooglePlayIntegrityTokenRepositoryImpl(context, standardIntegrityManagerProvider)
    }
}
