...
class KeyPairRepositoryImplTest {
    ...
    // @Test // This test is removed as per instruction
    ...
    // This test will run on API P (28) due to class-level @Config
    fun `generateKeyPair throws IllegalArgumentException if challenge is empty on N+ SDK`() = runTest(testDispatcher) {
        // Arrange
        val emptyChallenge = byteArrayOf()

        // Act
        keyPairRepository.generateKeyPair(emptyChallenge) // Should throw IllegalArgumentException
    }
}
